...
@test "remote_branch_checker/remote_branch_checker.sh: old branch failing" {
    ...
    "smurf,error,3,6:phplint,success,0,0;phpcs,success,0,0;js,warning,0,6;css,success,0,0;phpdoc,success,0,0;commit,error,3,0;savepoint,success,0,0;thirdparty,success,0,0;grunt,success,0,0;shifter,success,0,0;travis,success,0,0;mustachelint,success,0,0"
}
...
@test "remote_branch_checker/remote_branch_checker.sh: all possible checks failing" {
    ...
    "smurf,error,14,6:phplint,error,1,0;phpcs,error,2,2;js,error,2,1;css,error,1,1;phpdoc,success,0,0;commit,error,1,1;savepoint,error,2,0;thirdparty,warning,0,1;grunt,error,5,0;shifter,success,0,0;travis,success,0,0;mustachelint,success,0,0"
}
...
@test "remote_branch_checker/remote_branch_checker.sh: all checks passing" {
    ...
    "smurf,success,0,0:phplint,success,0,0;phpcs,success,0,0;js,success,0,0;css,success,0,0;phpdoc,success,0,0;commit,success,0,0;savepoint,success,0,0;thirdparty,success,0,0;grunt,success,0,0;shifter,success,0,0;travis,success,0,0;mustachelint,success,0,0"
}
...
@test "remote_branch_checker/remote_branch_checker.sh: stylelint checks" {
    ...
    "smurf,error,3,1:phplint,success,0,0;phpcs,success,0,0;js,success,0,0;css,error,3,1;phpdoc,success,0,0;commit,success,0,0;savepoint,success,0,0;thirdparty,success,0,0;grunt,success,0,0;shifter,success,0,0;travis,success,0,0;mustachelint,success,0,0"
}
...
@test "remote_branch_checker/remote_branch_checker.sh: thirdparty css modification" {
    ...
    "smurf,warning,0,2:phplint,success,0,0;phpcs,success,0,0;js,success,0,0;css,success,0,0;phpdoc,success,0,0;commit,success,0,0;savepoint,success,0,0;thirdparty,warning,0,2;grunt,success,0,0;shifter,success,0,0;travis,success,0,0;mustachelint,success,0,0"
}
...
@test "remote_branch_checker/remote_branch_checker.sh: bad amos script" {
    ...
    "smurf,error,2,0:phplint,success,0,0;phpcs,success,0,0;js,success,0,0;css,success,0,0;phpdoc,success,0,0;commit,error,2,0;savepoint,success,0,0;thirdparty,success,0,0;grunt,success,0,0;shifter,success,0,0;travis,success,0,0;mustachelint,success,0,0"
}
