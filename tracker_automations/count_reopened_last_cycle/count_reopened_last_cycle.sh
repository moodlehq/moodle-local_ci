...
# lets' look for all the reopenend issues that, being into
# any integration or testing status have been reopened since
...
${basereq} --action getIssueList \
           --search "project = 'Moodle' \
               ...
               AND status WAS IN ( \
                   ...
                   'Passed', \
                   'Failed', \
                   'Tested') AFTER ${lastintegrationdatequoted}" \
           --file "${tempfile}"
