# move_to_current_integration

**Tracker automation.** Moves awaiting-integration issues into current integration (clears integrator/date, sets flag, comments, drops ci label).
...
- `move_to_current_integration.sh`
